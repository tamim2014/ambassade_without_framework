...
//3.1 On construit une table d'affichage
				...
				while($ligne = $reponse->fetch()){// en utlisant FOREACH ça marche pas .j'sais pas pourquoi
				 ...
				 $table.='<tr><td></td><td></td><td>  </td><td>  </td><td> </td><td><span style="color:green;  font-size: 17px; font-style: bold;" >TOTAL :</span> </td><td><span style="color:green;  font-size: 17px; font-style: bold;" ></span> </td><td> </td> <td> </td> <tr>'; 
				 $table.='</table>';
