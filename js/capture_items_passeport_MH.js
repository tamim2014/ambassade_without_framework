...
//lectureBD.php
		 ...
		 $(document).ready(function(){
					...
					$("#J2015").click(function() {  /* Attention! pas d'ESPACE entre l'elt et sa classe  */ /* ICI ??a marche  */
					...
					// Afficher aussi la liste des passeports envoyés suite au clic sur lebouton submit
