	...
	// GESTION DES MENU DE LA PAGE lectureBD.php 
	   ...
	   *******************************************************************************************************/
	   ...
	   $(document).ready(function(){
		...
		//------------------------------------------------------------------------------------		
		//au clic sur les items du menugauche.php:Afficher(dans la div mnayvawo) la prefecture cliquée 
		...
		//-----------------------------------------------------------------------------------------------------------
		// Affichage sousmenu.php(liste des mois) à droite, suite au passage de la souris sur le sous menu de gauche(listes des iles)
		// PRINCIPE:L'affichage d'un sous menu fait disparaitre les autres sous menu	
			$(".sousmenu1 ").hide(); $(".sousmenu1_caisse ").hide(); $(".sousmenu2 ").hide(); $(".sousmenu3 ").hide();
		...
		//-------------------------------------------------------------------------------------------------------	
			$(".island1_caisse").mouseover(function(){ 
				$(".sousmenu2 ").hide(); $(".sousmenu3 ").hide();    $(".sousmenu1_caisse").show();   
                 $(" .panel3").slideDown(3000); // on peu aussi utiliser fadeIn("slow");  ou fadeIn(3000); 
				 $(".piedmenu").fadeIn(3000);// CELUI-CI ne respecte pas la vitesse d'affichage.Pourquoi? parcequ'on l'a attribué un display:block (et on peut enlever ça sinon il va s'afficher dans la mm ligne que le bouton precedenr)
			...
			$(".island2").mouseover(function(){
				 $(".sousmenu1 ").hide(); $(".sousmenu1_caisse ").hide(); $(".sousmenu3 ").hide();    $(".sousmenu2").show();  
                 $(" .panel3").slideDown(3000); 
				 $(".piedmenu").fadeIn(3000);
                 
			});
			$(".island2").mouseover(function(){
				 $(".sousmenu1_caisse ").hide();  $(".sousmenu3 ").hide();    $(".sousmenu2").show();  
                 $(" .panel3").slideDown(3000); 
				 $(".piedmenu").fadeIn(3000);
			...
			$(".island3").mouseover(function(){
				  $(".sousmenu1 ").hide(); $(".sousmenu1_caisse ").hide(); $(".sousmenu2 ").hide();    $(".sousmenu3").show();  
                 $(" .panel3").slideDown(3000);  
				 $(".piedmenu").fadeIn(3000);
		...
		//Cette action sera annoncé par unscript css3(hover:fond blanc+ message) voir lectureBD.css 
		    $(".piedSousMenuDroite").click(function(){
				...
				$(".sousmenu1 ,.sousmenu1_caisse , .sousmenu2 , .sousmenu3 ").fadeOut("slow" ); 
				 $(".sousmenu1 ,.sousmenu1_caisse , .sousmenu2 , .sousmenu3 ").fadeOut("slow",$("#panel2").show()  );
